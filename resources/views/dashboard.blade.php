            ...
            <div class="list-group">
                ...
                <a href="{{route('quiz.detail',$quiz->slug)}}" class="list-group-item list-group-item-action " aria-current="true">
                    <div class="d-flex w-100 justify-content-between">
                        ...
                        <small>{{$quiz->finished_at ? $quiz->finished_at->diffForHumans().' bitiyor' : null}}</small><!-- Eğer bitiş tarihi varsa bitiş tarihini yazdır -->
                    </div>
                    <p class="mb-1">{{ Str::limit($quiz->description,100)}}</p><!-- Açıklamayı göster ve limiti 100 harf olsun -->
